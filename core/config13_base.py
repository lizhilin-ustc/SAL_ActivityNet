...
_DATASET_HYPER_PARAMS = {
    ...
    "THUMOS":{
        ...
        "data_dir":"./data/THUMOS14/feature/",
    ...
    "ActivityNet":{
        ...
        "frames_per_sec":25,
        "segment_frames_num":16,
        "sample_segments_num":50,      # default=75
        
        "feature_dim":2048,
        "action_cls_num":len(_CLASS_NAME["ActivityNet"]),
        "cls_threshold":0.10,
        "test_upgrade_scale":20,
        "data_dir":"/data/lizl/ActivityNet13",
        "test_gt_file":"/data/lizl/ActivityNet13/gt.json",
        "tiou_thresholds":np.arange(0.50, 1.00, 0.05),
        "nms_thresh":0.90,     # default=0.9
...
def build_args(dataset=None):
    ...
    args.GPU_ID = '2'
    args.EXP = 'anet13'
    args.LR = '[0.0001]*50000'    # 0.0001
    args.NUM_ITERS = len(eval(args.LR))
    args.NUM_CLASSES = 200
    args.MODAL = 'all'
    args.FEATS_DIM = 2048
    args.BATCH_SIZE = 8  # 16
    args.DATA_PATH = '/data/lizl/ActivityNet13'
    args.NUM_WORKERS = 8
    args.LAMBDA = 0.01
    args.DATASET = "ANET1.3"
    args.EXP = "EXP-12"
    args.TEST_FREQ = 200    
    args.PRINT_FREQ = 100
    args.CLASS_THRESH = 0.1  
    args.SOFT_NMS = True
    args.NMS_ALPHA = 0.35
    args.NMS_THRESH = 0.7  
    args.CAS_THRESH = np.arange(0.1, 1.0, 0.1)
    args.TIOU_THRESH = np.linspace(0.5, 0.95, 10)
    args.UP_SCALE = 24
    args.GT_PATH = '/data/lizl/ActivityNet13/gt.json'
    args.SEED = 0
    args.MODE = 'train'
    args.MODEL_FILE = '/data/lizl/SAL_act/experiments/train/ANET1.3_EXP-BEST_freq_200_seed_0/model/model_best.pth.tar'
    args.FEATS_FPS = 25
    args.NUM_SEGMENTS = 50
    args.gamma = 0.2
    args.q = 0.5  
